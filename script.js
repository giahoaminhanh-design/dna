...
// Bản đồ ASEAN — dùng GeoJSON nhúng sẵn để không bị chặn fetch khi mở file://
...
const DATA = {
  'Vietnam':{capital:'Hà Nội',population:'~100 triệu',area:'~331.000 km²',gdp:'~430 tỷ USD',currency:'VND',language:'Tiếng Việt',culture:'Á Đông, ảnh hưởng Trung Hoa & Pháp'},
  ...
  'Timor-Leste':{capital:'Dili',population:'~1.4 triệu',area:'~15.000 km²',gdp:'~3 tỷ USD',currency:'USD',language:'Tetum/Portuguese',culture:'Quốc đảo non trẻ, lusophone'}
};

function getName(props){
  return props.NAME_0 || props.name || props.admin || props.ADMIN || props.country || props.sovereignt || props.sov_a3 || '—';
}
...
(function init(){
  try{
    ...
    if (!gj) throw new Error('GeoJSON không tồn tại');
    ...
    console.error(e);
    showStatus('Lỗi khởi tạo dữ liệu.', true);
  }
})();
